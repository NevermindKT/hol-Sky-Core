...
@export var night_sun_elevation_deg := -30.0
...
func play_dusk_intro() -> void:
	...
	directional_light.light_energy = dusk_light_energy
	...
	active_tween.tween_property(self, "current_sun_elevation_deg", night_sun_elevation_deg, dusk_duration)
	...
	active_tween.tween_property(directional_light, "light_energy", night_light_energy, dusk_duration)

	active_tween.chain().tween_callback(func(): directional_light.sky_mode = night_sky_mode)
...
func play_deadly_dawn() -> void:
	...
	active_tween.tween_property(directional_light, "light_energy", dawn_light_energy, dawn_duration)
